        ...
        <div className="px-4 mb-2 mt-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#F2F2F2] dark:bg-gray-800 border-none text-sm placeholder-gray-500 dark:placeholder-gray-400 text-gray-700 dark:text-gray-200 rounded-lg focus:ring-0 pl-9 pr-8 py-2 transition-colors duration-300"
            />
            {searchQuery && (
              <button
                onClick={() => {
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 p-1 hover:bg-gray-300 dark:hover:bg-gray-700 rounded-full transition-colors"
              >
            ...
            <div className="pt-2">
              <div className="flex items-center justify-between px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                ...
                <span className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded-full text-[10px]">
                  {sessions.filter(s => s.title.toLowerCase().includes(searchQuery.toLowerCase())).length}
                </span>
              </div>
